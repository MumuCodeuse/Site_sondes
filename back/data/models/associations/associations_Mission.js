...
export default function associateMissionModels() {
  // 0) liaison entre Missions et SpaceProbe. Cardinalités, Mission: 1,N et SpaceProbe: 1,N. Une sonde appartenant a une mission peut être réaffectée à une extension de mission qui a un autre nom de mission. D'où ce choix de SpaceProbe: 1,N.
  //Obtenir toutes les sondes d'une mission

  Mission.belongsToMany(SpaceProbe, {
    through: "tl_probe_mission",
    foreignKey: "mission_id",
    otherKey: "space_probe_id",
    as: "spacesProbeMission",
  });

  // La réciproque, obtenir toutes les missions / extensions auquelles a participé une sonde.
  // Toutes les missions d'une sonde
  SpaceProbe.belongsToMany(Mission, {
    through: "tl_probe_mission",
    foreignKey: "space_probe_id",
    otherKey: "mission_id",
    as: "missionsSpaceProbe",
  });

  // --------------------------------

  // 1) liaison entre Mission et EventMission. Cardinalités, Mission: 0,N et EventMission: 0,N. Une mission qui a avorté n'a pas d'événement,
